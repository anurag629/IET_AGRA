        ...
        <section className="bg-white dark:bg-gray-900">
            ...
            <div className="px-4 mx-auto max-w-screen-xl text-center lg:px-6">
                <div class="container mx-auto p-8">
                    <h1 class="text-4xl font-bold text-center text-indigo-600">Celebrating Excellence, Forging Futures</h1>
                    <div class="mt-4 bg-white rounded-lg shadow-lg p-6">
                        <h2 class="text-2xl font-semibold text-indigo-600">Meet Our College Topper</h2>
                    </div>
                </div>
